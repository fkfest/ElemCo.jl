...
\begin{equation}
E^{(2)}_{\beta\beta} = \frac{1}{2} \sum_{IJAB} v_{IJ}^{AB} \, T_{IJ}^{AB,\beta\beta}.
\end{equation}

\paragraph{Opposite-spin $\alpha\beta$.}
No exchange, no antisymmetry, no overcounting:
\begin{equation}
E^{(2)}_{\alpha\beta} = \sum_{iJaB} \frac{(v_{iJ}^{aB})^2}{\Delta_{iJaB}^{\alpha\beta}}
= \sum_{iJaB} v_{iJ}^{aB} \, T_{iJ}^{aB,\alpha\beta}.
\end{equation}
...
+ \frac{1}{2} \sum_{IJAB} v_{IJ}^{AB} \, T_{IJ}^{AB,\beta\beta}
+ \sum_{iJaB} v_{iJ}^{aB} \, T_{iJ}^{aB,\alpha\beta},}
\end{equation}
with amplitudes
\begin{equation}
