...
\brown{M^{\spa{i}}_{\spa{a}}} &= \brown{T^{\spa{t}}_{\spa{u}} T^{\spb{u}\spb{i}}_{\spb{a}\spb{t}} + T^{\spa{t}}_{\spa{u}} T^{\spb{i}\spb{u}}_{\spb{t}\spb{a}}}, \\
...
\brown{M^{\spb{i}}_{\spb{a}}} &= \brown{T^{\spb{u}}_{\spb{t}} T^{\spa{t}\spa{i}}_{\spa{a}\spa{u}} + T^{\spb{u}}_{\spb{t}} T^{\spa{i}\spa{t}}_{\spa{u}\spa{a}}}, \\
