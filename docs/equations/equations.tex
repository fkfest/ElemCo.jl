...
\begin{equation}
\begin{aligned}
\mathcal{P}(ai;bj) X^{ij}_{ab} &= X^{ij}_{ab} + X^{ji}_{ba}\\
\bar{\mathcal{P}}(ai;bj) &= \mathcal{P}(ai;bj) - \mathcal{P}(bi;aj)\\
\end{aligned}
\end{equation}
...
&+ Λ_{\spa{i}\spa{j}}^{\spa{a}\spa{b}} \mathcal{P}(\spa{a}\spa{i};\spa{b}\spa{j})\left\{
...
&+ Λ_{\spa{i}\spa{j}}^{\spa{a}\spa{b}} \bar{\mathcal{P}}(\spa{a}\spa{i};\spa{b}\spa{j})\left\{
...
+\bar{\mathcal{P}}(\spa{i}\spa{r};\spa{j}\spa{s}) δ_{\spa{r}}^{\spa{i}} T^{\spa{j}}_{\spa{b}} δ_{\spa{s}}^{\spa{b}}  
