...
residuals and amplitudes from the spin-dependent equations in each iteration. 
...
\end{equation}
The all internal singles $T^{\spa{t}}_{\spa{u}}$, $T^{\spb{u}}_{\spb{t}}$ and doubles $T^{\spa{t}\spb{u}}_{\spa{u}\spb{t}}$ coupled cluster amplitude 
is set to zero at the beginning of every iteration.
At the end of every iteration the all internal doubles residuum $R^{\spa{t}\spb{u}}_{\spa{u}\spb{t}}$ is set to zero, but \emph{not} the singles residuum.
