...
PAOs are selected by a pivoted Cholesky of $S_{\mathrm{PAO}}$ and orthogonalized by a symmetric
L\"owdin transformation, keeping the OPAOs local. This yields orthogonal PAOs
\begin{equation}
