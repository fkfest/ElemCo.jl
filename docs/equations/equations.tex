...
\lstset{language=[LaTeX]Tex, frame=shadowbox, rulesepcolor=\color{gray}, basicstyle=\ttfamily\scriptsize, breaklines=true}
\begin{lstlisting}
...
\eeq
\beq
<\Phi^{abc}_{ijk}| \op H (\op T_2 + \op T_3 + \half \op T_2 \op T_2 
+ \op T_2 \op T_3) |0>_C
\end{lstlisting}
