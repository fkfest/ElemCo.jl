...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x,c=>10*x) R3abb[a,A,B,i,I,J] += 0.5 * oovv[k,j,b,c] * T2a[b,c,i,j] * T3abb[a,A,B,k,J,I]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += 0.5 * oovv[k,j,c,b] * T2a[b,a,j,k] * T3abb[c,B,A,i,I,J]
...
oovv = nothing
OOVV = ints2(EC,"OOVV")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x,C=>10*x) R3aab[a,b,A,i,j,I] += 0.5 * OOVV[K,J,B,C] * T2b[B,C,I,J] * T3aab[a,b,A,j,i,K]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += 0.5 * OOVV[K,J,C,B] * T2b[B,A,J,K] * T3aab[b,a,C,i,j,I]
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += 0.5 * oOvV[k,J,c,B] * T2ab[c,B,k,I] * T3aab[a,b,A,j,i,J]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += 0.5 * oOvV[k,J,c,B] * T2ab[c,A,k,J] * T3aab[b,a,B,i,j,I]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += 0.5 * oOvV[j,K,b,C] * T2ab[b,C,i,K] * T3abb[a,A,B,j,J,I]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += 0.5 * oOvV[j,K,b,C] * T2ab[a,C,j,K] * T3abb[b,B,A,i,I,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
