...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,d=>10*x,c=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,c=>10*x,d=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,b=>10*x,c=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,c=>10*x,b=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,l=>x,e=>10*x,d=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,l=>x,d=>10*x,e=>10*x) begin
...
d_vovv = nothing
d_VOVV = load4idx(EC,"d_VOVV")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,J=>x,B=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,J=>x,C=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,K=>x,D=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,K=>x,C=>10*x,D=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,K=>x,b=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,I=>x,d=>10*x,A=>10*x) begin
...
@tensoropt R3abb[b,A,B,j,I,J] -= d_vovo[b,i,a,j] * T3abb[a,A,B,i,I,J]
@tensoropt begin
...
d_vovo = nothing
d_VOVO = load4idx(EC,"d_VOVO")
@tensoropt R3aab[a,b,B,i,j,J] -= d_VOVO[B,I,A,J] * T3aab[a,b,A,i,j,I]
@tensoropt begin
...
@tensoropt R3abb[b,A,B,j,I,J] += d_voov[b,i,j,a] * T3abb[a,A,B,i,I,J]
@tensoropt begin
...
d_voov = nothing
d_VOOV = load4idx(EC,"d_VOOV")
@tensoropt R3aab[a,b,B,i,j,J] += d_VOOV[B,I,J,A] * T3aab[a,b,A,i,j,I]
@tensoropt begin
...
@tensoropt R3abb[a,B,C,i,J,K] += d_vOoV[a,I,i,A] * T3b[B,C,A,J,K,I]
@tensoropt begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,c=>10*x) begin
...
@tensoropt (b=>10*x,a=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,c=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x) begin
...
@tensoropt (b=>10*x,c=>10*x,a=>10*x,k=>x,i=>x,j=>x,m=>x,l=>x,d=>10*x) begin
...
@tensoropt (b=>10*x,a=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,d=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,d=>10*x) begin
...
@tensoropt (c=>10*x,a=>10*x,b=>10*x,k=>x,i=>x,j=>x,m=>x,l=>x,d=>10*x) begin
...
d_oovo = nothing
d_OOVO = load4idx(EC,"d_OOVO")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,C=>10*x) begin
...
@tensoropt (a=>10*x,B=>10*x,A=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,C=>10*x) begin
...
d_OOVO = nothing
d_oOvO = load4idx(EC,"d_oOvO")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x) begin
...
@tensoropt (C=>10*x,A=>10*x,B=>10*x,K=>x,I=>x,J=>x,i=>x,L=>x,a=>10*x) begin
...
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,i=>x,L=>x,a=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,C=>10*x) begin
...
@tensoropt (c=>10*x,a=>10*x,b=>10*x,k=>x,i=>x,j=>x,l=>x,I=>x,A=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,l=>x,I=>x,A=>10*x) begin
...
@tensoropt R3aab[b,c,A,j,k,I] += d_oVvO[i,A,a,I] * T3a[b,c,a,j,k,i]
@tensoropt begin
...
d_oVoV = nothing
oovv = ints2(EC,"oovv")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,c=>10*x,d=>10*x) begin
X[a,b,A,i,j,I] := oovv[l,k,c,d] * T2a[a,c,i,k] * T3aab[b,d,A,j,l,I]
R3aab[a,b,A,i,j,I] -= X[a,b,A,i,j,I]
R3aab[b,a,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[a,b,A,j,i,I] += X[a,b,A,i,j,I]
R3aab[b,a,A,j,i,I] -= X[a,b,A,i,j,I]
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) begin
X[a,b,A,i,j,I] := oovv[l,k,d,c] * T2a[d,c,i,k] * T3aab[a,b,A,j,l,I]
R3aab[a,b,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[a,b,A,j,i,I] -= X[a,b,A,i,j,I]
end
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,c=>10*x,d=>10*x) R3aab[a,b,A,i,j,I] -= oovv[l,k,c,d] * T2ab[c,A,k,I] * T3a[a,b,d,i,j,l]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) R3aab[a,b,A,i,j,I] += oovv[l,k,d,c] * T2ab[c,A,k,I] * T3a[a,b,d,i,j,l]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x,c=>10*x) begin
X[a,A,B,i,I,J] := oovv[k,j,b,c] * T2ab[b,A,j,I] * T3aab[a,c,B,i,k,J]
R3abb[a,A,B,i,I,J] -= X[a,A,B,i,I,J]
R3abb[a,B,A,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,A,B,i,J,I] += X[a,A,B,i,I,J]
R3abb[a,B,A,i,J,I] -= X[a,A,B,i,I,J]
end
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x,c=>10*x) R3abb[a,A,B,i,I,J] -= oovv[k,j,b,c] * T2a[a,b,i,j] * T3abb[c,A,B,k,I,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += oovv[k,j,c,b] * T2a[c,b,i,j] * T3abb[a,A,B,k,J,I]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += oovv[k,j,c,b] * T2a[b,a,j,k] * T3abb[c,B,A,i,I,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += oovv[k,j,c,b] * T2a[a,b,i,j] * T3abb[c,A,B,k,I,J]
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,j=>x,i=>x,a=>10*x,b=>10*x) begin
X[A,B,C,I,J,K] := oovv[j,i,a,b] * T2ab[a,A,i,I] * T3abb[b,B,C,j,J,K]
R3b[A,B,C,I,J,K] -= X[A,B,C,I,J,K]
R3b[B,A,C,I,J,K] += X[A,B,C,I,J,K]
R3b[B,C,A,I,J,K] -= X[A,B,C,I,J,K]
R3b[A,B,C,J,I,K] += X[A,B,C,I,J,K]
...
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,j=>x,i=>x,b=>10*x,a=>10*x) begin
...
R3a[a,b,c,i,k,j] -= X[a,b,c,i,j,k]
R3a[b,a,c,i,j,k] -= X[a,b,c,i,j,k]
R3a[b,a,c,i,k,j] += X[a,b,c,i,j,k]
R3a[b,c,a,i,j,k] += X[a,b,c,i,j,k]
R3a[b,c,a,i,k,j] -= X[a,b,c,i,j,k]
R3a[a,b,c,k,i,j] += X[a,b,c,i,j,k]
R3a[b,a,c,k,i,j] -= X[a,b,c,i,j,k]
R3a[b,c,a,k,i,j] += X[a,b,c,i,j,k]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
...
X[a,b,c,i,j,k] := oovv[m,l,d,e] * T2a[a,d,i,l] * T3a[b,c,e,j,k,m]
R3a[a,b,c,i,j,k] -= X[a,b,c,i,j,k]
R3a[b,a,c,i,j,k] += X[a,b,c,i,j,k]
R3a[b,c,a,i,j,k] -= X[a,b,c,i,j,k]
R3a[a,b,c,j,i,k] += X[a,b,c,i,j,k]
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,e,d] * T2a[e,d,i,l] * T3a[a,b,c,j,k,m]
R3a[a,b,c,i,j,k] -= X[a,b,c,i,j,k]
R3a[a,b,c,j,i,k] += X[a,b,c,i,j,k]
R3a[a,b,c,j,k,i] -= X[a,b,c,i,j,k]
end
...
oovv = nothing
OOVV = ints2(EC,"OOVV")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x,C=>10*x) begin
X[a,b,A,i,j,I] := OOVV[K,J,B,C] * T2ab[a,B,i,J] * T3abb[b,A,C,j,I,K]
R3aab[a,b,A,i,j,I] -= X[a,b,A,i,j,I]
R3aab[b,a,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[a,b,A,j,i,I] += X[a,b,A,i,j,I]
R3aab[b,a,A,j,i,I] -= X[a,b,A,i,j,I]
end
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x,C=>10*x) R3aab[a,b,A,i,j,I] -= OOVV[K,J,B,C] * T2b[A,B,I,J] * T3aab[a,b,C,i,j,K]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += OOVV[K,J,C,B] * T2b[C,B,I,J] * T3aab[a,b,A,j,i,K]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += OOVV[K,J,C,B] * T2b[B,A,J,K] * T3aab[b,a,C,i,j,I]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += OOVV[K,J,C,B] * T2b[A,B,I,J] * T3aab[a,b,C,i,j,K]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,C=>10*x,D=>10*x) begin
X[a,A,B,i,I,J] := OOVV[L,K,C,D] * T2b[A,C,I,K] * T3abb[a,B,D,i,J,L]
R3abb[a,A,B,i,I,J] -= X[a,A,B,i,I,J]
R3abb[a,B,A,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,A,B,i,J,I] += X[a,A,B,i,I,J]
R3abb[a,B,A,i,J,I] -= X[a,A,B,i,I,J]
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) begin
X[a,A,B,i,I,J] := OOVV[L,K,D,C] * T2b[D,C,I,K] * T3abb[a,A,B,i,J,L]
R3abb[a,A,B,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,A,B,i,J,I] -= X[a,A,B,i,I,J]
end
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,C=>10*x,D=>10*x) R3abb[a,A,B,i,I,J] -= OOVV[L,K,C,D] * T2ab[a,C,i,K] * T3b[A,B,D,I,J,L]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += OOVV[L,K,D,C] * T2ab[a,C,i,K] * T3b[A,B,D,I,J,L]
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,M=>x,L=>x,E=>10*x,D=>10*x) begin
...
R3b[A,B,C,I,K,J] -= X[A,B,C,I,J,K]
R3b[B,A,C,I,J,K] -= X[A,B,C,I,J,K]
R3b[B,A,C,I,K,J] += X[A,B,C,I,J,K]
R3b[B,C,A,I,J,K] += X[A,B,C,I,J,K]
R3b[B,C,A,I,K,J] -= X[A,B,C,I,J,K]
R3b[A,B,C,K,I,J] += X[A,B,C,I,J,K]
R3b[B,A,C,K,I,J] -= X[A,B,C,I,J,K]
R3b[B,C,A,K,I,J] += X[A,B,C,I,J,K]
end
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,M=>x,L=>x,E=>10*x,D=>10*x) begin
...
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,M=>x,L=>x,D=>10*x,E=>10*x) begin
X[A,B,C,I,J,K] := OOVV[M,L,D,E] * T2b[A,D,I,L] * T3b[B,C,E,J,K,M]
R3b[A,B,C,I,J,K] -= X[A,B,C,I,J,K]
R3b[B,A,C,I,J,K] += X[A,B,C,I,J,K]
R3b[B,C,A,I,J,K] -= X[A,B,C,I,J,K]
R3b[A,B,C,J,I,K] += X[A,B,C,I,J,K]
...
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,M=>x,L=>x,E=>10*x,D=>10*x) begin
X[A,B,C,I,J,K] := OOVV[M,L,E,D] * T2b[E,D,I,L] * T3b[A,B,C,J,K,M]
R3b[A,B,C,I,J,K] -= X[A,B,C,I,J,K]
R3b[A,B,C,J,I,K] += X[A,B,C,I,J,K]
R3b[A,B,C,J,K,I] -= X[A,B,C,I,J,K]
end
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,J=>x,I=>x,A=>10*x,B=>10*x) begin
X[a,b,c,i,j,k] := OOVV[J,I,A,B] * T2ab[a,A,i,I] * T3aab[b,c,B,j,k,J]
R3a[a,b,c,i,j,k] -= X[a,b,c,i,j,k]
R3a[b,a,c,i,j,k] += X[a,b,c,i,j,k]
R3a[b,c,a,i,j,k] -= X[a,b,c,i,j,k]
R3a[a,b,c,j,i,k] += X[a,b,c,i,j,k]
...
oOvV = ints2(EC,"oOvV")
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
X[a,b,A,i,j,I] := oOvV[k,J,c,B] * T2ab[c,B,i,I] * T3aab[a,b,A,j,k,J]
R3aab[a,b,A,i,j,I] -= 0.5 * X[a,b,A,i,j,I]
R3aab[a,b,A,i,j,I] += 0.5 * X[b,a,A,i,j,I]
R3aab[a,b,A,j,i,I] += 0.5 * X[a,b,A,i,j,I]
R3aab[a,b,A,j,i,I] -= 0.5 * X[b,a,A,i,j,I]
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
X[a,b,A,i,j,I] := oOvV[k,J,c,B] * T2ab[a,A,k,J] * T3aab[b,c,B,i,j,I]
R3aab[a,b,A,i,j,I] -= 0.5 * X[a,b,A,i,j,I]
R3aab[b,a,A,i,j,I] += 0.5 * X[a,b,A,i,j,I]
R3aab[a,b,A,i,j,I] += 0.5 * X[a,b,A,j,i,I]
R3aab[b,a,A,i,j,I] -= 0.5 * X[a,b,A,j,i,I]
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
X[a,b,A,i,j,I] := oOvV[k,J,c,B] * T2ab[c,A,i,J] * T3aab[b,a,B,j,k,I]
R3aab[a,b,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[a,b,A,j,i,I] -= X[a,b,A,i,j,I]
end
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
X[a,b,A,i,j,I] := oOvV[k,J,c,B] * T2ab[a,B,k,I] * T3aab[c,b,A,i,j,J]
R3aab[a,b,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[b,a,A,i,j,I] -= X[a,b,A,i,j,I]
end
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2ab[c,B,k,I] * T3aab[a,b,A,j,i,J]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2ab[c,A,k,J] * T3aab[b,a,B,i,j,I]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2b[A,B,I,J] * T3a[a,b,c,i,j,k]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2ab[c,A,k,I] * T3aab[a,b,B,i,j,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
X[a,A,B,i,I,J] := oOvV[j,K,b,C] * T2ab[b,C,i,I] * T3abb[a,A,B,j,J,K]
R3abb[a,A,B,i,I,J] -= 0.5 * X[a,A,B,i,I,J]
R3abb[a,A,B,i,I,J] += 0.5 * X[a,B,A,i,I,J]
R3abb[a,A,B,i,J,I] += 0.5 * X[a,A,B,i,I,J]
R3abb[a,A,B,i,J,I] -= 0.5 * X[a,B,A,i,I,J]
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
X[a,A,B,i,I,J] := oOvV[j,K,b,C] * T2ab[a,A,j,K] * T3abb[b,B,C,i,I,J]
R3abb[a,A,B,i,I,J] -= 0.5 * X[a,A,B,i,I,J]
R3abb[a,B,A,i,I,J] += 0.5 * X[a,A,B,i,I,J]
R3abb[a,A,B,i,I,J] += 0.5 * X[a,A,B,i,J,I]
R3abb[a,B,A,i,I,J] -= 0.5 * X[a,A,B,i,J,I]
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
X[a,A,B,i,I,J] := oOvV[j,K,b,C] * T2ab[a,C,j,I] * T3abb[b,B,A,i,J,K]
R3abb[a,A,B,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,A,B,i,J,I] -= X[a,A,B,i,I,J]
end
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
X[a,A,B,i,I,J] := oOvV[j,K,b,C] * T2ab[b,A,i,K] * T3abb[a,C,B,j,I,J]
R3abb[a,A,B,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,B,A,i,I,J] -= X[a,A,B,i,I,J]
end
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2ab[b,C,i,K] * T3abb[a,A,B,j,J,I]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2ab[a,C,j,K] * T3abb[b,B,A,i,I,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2ab[a,C,i,K] * T3abb[b,A,B,j,I,J]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2a[a,b,i,j] * T3b[A,B,C,I,J,K]
@tensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,i=>x,L=>x,a=>10*x,D=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,l=>x,I=>x,d=>10*x,A=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,c=>10*x,B=>10*x) begin
...
@tensoropt (A=>10*x,B=>10*x,C=>10*x,J=>x,I=>x,K=>x,i=>x,a=>10*x,D=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,l=>x,d=>10*x) begin
...
@tensoropt R3abb[a,A,B,j,I,J] += fij[i,j] * T3abb[a,A,B,i,J,I]
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,b=>10*x) begin
...
@tensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,K=>x,C=>10*x) begin
X[a,A,B,i,I,J] := fIA[K,C] * T2ab[a,A,i,K] * T2b[B,C,I,J]
R3abb[a,A,B,i,I,J] += X[a,A,B,i,I,J]
R3abb[a,B,A,i,I,J] -= X[a,A,B,i,I,J]
end
@tensoropt R3abb[b,A,B,i,I,J] -= fab[b,a] * T3abb[a,B,A,i,I,J]
@tensoropt begin
...
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,c=>10*x) begin
X[a,b,A,i,j,I] := fia[k,c] * T2ab[a,A,k,I] * T2a[b,c,i,j]
R3aab[a,b,A,i,j,I] += X[a,b,A,i,j,I]
R3aab[b,a,A,i,j,I] -= X[a,b,A,i,j,I]
end
@tensoropt R3aab[a,b,A,i,j,J] += fIJ[I,J] * T3aab[a,b,A,j,i,I]
@tensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,J=>x,B=>10*x) begin
...
@tensoropt R3aab[a,b,B,i,j,I] -= fAB[B,A] * T3aab[b,a,A,i,j,I]
@tensoropt begin
...
function ccsdt_triples!(EC::ECInfo, R3, T2, T3, fij, fab, fai, fia)
#bract
...
d_vvvo = nothing
d_vovv = load4idx(EC,"d_vovv")
@tensoropt (c=>10*x,a=>10*x,b=>10*x,j=>x,k=>x,i=>x,l=>x,d=>10*x,e=>10*x) begin
X[c,a,b,j,k,i] := d_vovv[a,l,d,e] * T2[d,b,l,i] * T2[e,c,k,j]
R3[c,a,b,j,k,i] -= X[c,a,b,j,k,i]
R3[c,b,a,j,i,k] -= X[c,a,b,j,k,i]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,k=>x,i=>x,l=>x,e=>10*x,d=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,l=>x,d=>10*x,e=>10*x) begin
...
d_oovo = nothing
oovv = ints2(EC,"oovv")
@tensoropt (b=>10*x,a=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[b,a,c,i,j,k] := oovv[m,l,e,d] * T2[d,a,i,j] * T3[b,c,e,l,m,k]
R3[b,a,c,i,j,k] += X[b,a,c,i,j,k]
R3[b,c,a,i,k,j] += X[b,a,c,i,j,k]
...
@tensoropt (b=>10*x,a=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[b,a,c,i,j,k] := oovv[m,l,e,d] * T2[d,a,i,j] * T3[e,b,c,l,m,k]
R3[b,a,c,i,j,k] += X[b,a,c,i,j,k]
R3[b,c,a,i,k,j] += X[b,a,c,i,j,k]
R3[a,b,c,i,j,k] += X[b,a,c,j,i,k]
R3[b,c,a,k,i,j] += X[c,a,b,i,j,k]
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,e,d] * T2[d,e,i,j] * T3[a,b,c,l,m,k]
R3[a,b,c,i,j,k] += X[a,b,c,i,j,k]
R3[a,b,c,i,k,j] += X[a,c,b,i,j,k]
R3[a,b,c,k,i,j] += X[b,c,a,i,j,k]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,j,i,k] := oovv[m,l,e,d] * T2[a,b,l,i] * T3[d,c,e,j,m,k]
R3[a,b,c,j,i,k] += X[a,b,c,j,i,k]
R3[a,c,b,j,k,i] += X[a,b,c,j,i,k]
R3[a,b,c,i,j,k] += X[b,a,c,j,i,k]
R3[c,a,b,j,k,i] += X[a,b,c,k,i,j]
...
X[a,b,c,j,i,k] := oovv[m,l,d,e] * T2[a,d,l,i] * T3[e,b,c,j,m,k]
R3[a,b,c,j,i,k] += X[a,b,c,j,i,k]
R3[a,b,c,j,k,i] += X[a,c,b,j,i,k]
R3[b,a,c,i,j,k] += X[a,b,c,j,i,k]
R3[b,a,c,j,k,i] += X[a,c,b,k,i,j]
R3[b,c,a,i,j,k] += X[a,b,c,k,i,j]
R3[b,c,a,j,i,k] += X[a,c,b,k,i,j]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,d=>10*x,e=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,d,e] * T2[d,a,l,i] * T3[e,b,c,j,m,k]
R3[a,b,c,i,j,k] += X[a,b,c,i,j,k]
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,j,i,k] := oovv[m,l,e,d] * T2[a,b,l,i] * T3[d,e,c,m,j,k]
R3[a,b,c,j,i,k] += X[a,b,c,j,i,k]
R3[a,c,b,j,k,i] += X[a,b,c,j,i,k]
R3[a,b,c,i,j,k] += X[b,a,c,j,i,k]
R3[c,a,b,j,k,i] += X[a,b,c,k,i,j]
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,d=>10*x,e=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,d,e] * T2[a,d,l,i] * T3[e,b,c,m,j,k]
R3[a,b,c,i,j,k] += X[a,b,c,i,j,k]
R3[b,a,c,j,i,k] += X[a,b,c,i,j,k]
R3[b,c,a,j,k,i] += X[a,b,c,i,j,k]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,e,d] * T2[a,b,l,m] * T3[d,e,c,i,j,k]
R3[a,b,c,i,j,k] += X[a,b,c,i,j,k]
R3[a,c,b,i,j,k] += X[a,b,c,i,k,j]
R3[c,a,b,i,j,k] += X[a,b,c,j,k,i]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
...
@tensoropt (b=>10*x,a=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[b,a,c,i,j,k] := oovv[m,l,e,d] * T2[d,a,i,j] * T3[b,e,c,l,m,k]
R3[b,a,c,i,j,k] -= 2 * X[b,a,c,i,j,k]
R3[b,c,a,i,k,j] -= 2 * X[b,a,c,i,j,k]
R3[a,b,c,i,j,k] -= 2 * X[b,a,c,j,i,k]
R3[b,c,a,k,i,j] -= 2 * X[c,a,b,i,j,k]
R3[a,b,c,i,k,j] -= 2 * X[c,a,b,j,i,k]
R3[b,a,c,k,i,j] -= 2 * X[c,a,b,j,i,k]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
X[a,b,c,j,i,k] := oovv[m,l,e,d] * T2[a,b,l,i] * T3[d,e,c,j,m,k]
R3[a,b,c,j,i,k] -= 2 * X[a,b,c,j,i,k]
R3[a,c,b,j,k,i] -= 2 * X[a,b,c,j,i,k]
R3[a,b,c,i,j,k] -= 2 * X[b,a,c,j,i,k]
R3[c,a,b,j,k,i] -= 2 * X[a,b,c,k,i,j]
R3[a,c,b,i,j,k] -= 2 * X[b,a,c,k,i,j]
R3[c,a,b,j,i,k] -= 2 * X[b,a,c,k,i,j]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,d=>10*x,e=>10*x) begin
X[a,b,c,i,j,k] := oovv[m,l,d,e] * T2[d,a,l,i] * T3[e,b,c,m,j,k]
R3[a,b,c,i,j,k] -= 2 * X[a,b,c,i,j,k]
...
R3[a,b,c,i,j,k] -= 2 * X[a,b,c,i,j,k]
R3[a,b,c,j,i,k] -= 2 * X[b,a,c,i,j,k]
R3[a,b,c,j,k,i] -= 2 * X[c,a,b,i,j,k]
end
@tensoropt (a=>10*x,b=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
...
@tensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,l=>x,d=>10*x) begin
