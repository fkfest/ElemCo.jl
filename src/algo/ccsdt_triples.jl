...
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,c=>10*x,d=>10*x) R3aab[a,b,A,i,j,I] -= oovv[l,k,c,d] * T2ab[c,A,k,I] * T3a[a,b,d,i,j,l]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,l=>x,k=>x,d=>10*x,c=>10*x) begin
...
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x,c=>10*x) begin
...
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,b=>10*x,c=>10*x) R3abb[a,A,B,i,I,J] -= oovv[k,j,b,c] * T2a[a,b,i,j] * T3abb[c,A,B,k,I,J]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += oovv[k,j,c,b] * T2a[c,b,i,j] * T3abb[a,A,B,k,J,I]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) R3abb[a,A,B,i,I,J] += oovv[k,j,c,b] * T2a[b,a,j,k] * T3abb[c,B,A,i,I,J]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,k=>x,j=>x,c=>10*x,b=>10*x) begin
...
@mtensoropt (A=>10*x,B=>10*x,C=>10*x,I=>x,J=>x,K=>x,j=>x,i=>x,a=>10*x,b=>10*x) begin
...
oovv = nothing
OOVV = ints2(EC,"OOVV")
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x,C=>10*x) begin
...
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,B=>10*x,C=>10*x) R3aab[a,b,A,i,j,I] -= OOVV[K,J,B,C] * T2b[A,B,I,J] * T3aab[a,b,C,i,j,K]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += OOVV[K,J,C,B] * T2b[C,B,I,J] * T3aab[a,b,A,j,i,K]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += OOVV[K,J,C,B] * T2b[B,A,J,K] * T3aab[b,a,C,i,j,I]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,K=>x,J=>x,C=>10*x,B=>10*x) begin
...
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,C=>10*x,D=>10*x) R3abb[a,A,B,i,I,J] -= OOVV[L,K,C,D] * T2ab[a,C,i,K] * T3b[A,B,D,I,J,L]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,L=>x,K=>x,D=>10*x,C=>10*x) begin
...
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2ab[c,B,k,I] * T3aab[a,b,A,j,i,J]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) R3aab[a,b,A,i,j,I] += oOvV[k,J,c,B] * T2ab[c,A,k,J] * T3aab[b,a,B,i,j,I]
@mtensoropt (a=>10*x,b=>10*x,A=>10*x,i=>x,j=>x,I=>x,k=>x,J=>x,c=>10*x,B=>10*x) begin
...
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2ab[b,C,i,K] * T3abb[a,A,B,j,J,I]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) R3abb[a,A,B,i,I,J] += oOvV[j,K,b,C] * T2ab[a,C,j,K] * T3abb[b,B,A,i,I,J]
@mtensoropt (a=>10*x,A=>10*x,B=>10*x,i=>x,I=>x,J=>x,j=>x,K=>x,b=>10*x,C=>10*x) begin
...
d_oovo = nothing
oovv = ints2(EC,"oovv")
@mtensoropt (b=>10*x,a=>10*x,c=>10*x,i=>x,j=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
...
@mtensoropt (a=>10*x,b=>10*x,c=>10*x,j=>x,i=>x,k=>x,m=>x,l=>x,e=>10*x,d=>10*x) begin
